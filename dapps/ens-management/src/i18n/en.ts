...
export const en = {
  "_ensmanagement": {
    ...
    "buy-dispatcher": {
      ...
      "title": "Buy ENS domain"
    },
    "cancel": "cancel",
    "content": "Data",
    "content-desc": "DBCP information",
    "contentAddress": {
      "desc": "DBCP - IPFS address for stored data",
      "error": "Please enter a valid IPFS address!",
      "title": "Data address"
    },
    ...
    "registrar": {
      "desc": "Determines the management of Sub ENS addresses.",
      "error": "Please enter a valid contract address.",
