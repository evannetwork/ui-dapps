...
export default {
  "_digitaltwins": {
    ...
    "start": {
      "add": {
        "desc": "Erstellen Sie eine neue digitale Zwilling auf Grundlage ihrer bestehenden Vorlagen oder öffnen Sie Bestehende.",
      ...
      "templates": {
        "desc": "Verwalten Sie Vorlagen für Ihre digitalen Zwillinge.",
        "title": "Meine Vorlagen"
      }
    },
