...
export const de = {
  "_explorer": {
    ...
    "choose-abi-contracts-desc": "Versuche Sie eine ABI Definition von bestehenden evan.network Verträgen zu laden und den Vertrag über dieses Interface anzuschauen.",
    ...
    "datacontract": {
      ...
      "data-schema": "Datenschema",
      "encrypt-hashes": "Hashes verschlüsseln",
      "encrypt-hashes-desc": "Verschlüsselt und entschlüsselt automatisch alle Einträge.",
    ...
    "invalid-abi-desc": "Bitte geben Sie eine gültige ABI-Beschreibung an. Es handelt sich in der Regel um ein stringified JSON-Array.",
