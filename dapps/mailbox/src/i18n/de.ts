...
export const de = {
  ...
  "_dappmailbox": {
    ...
    "comm-key-error": " Während der Kommunkationsschlüssel gespeichert wurde, ist ein Fehler aufgetreten.<br> Bitte versuchen sie es erneut. <br><br> Dieser Fehler kann in den folgenden Fällen auftreten: <ul><li>Sie haben bereits eine weiter Einladung an den selben Nutzer geschickt</li><li>Ihr Kontakt hat Ihnen einen invaliden Kommunikationsschlüssel zurück gesendet.</li> </ul> <br> Wenn sie ein weiteres mal versucht haben, diesen Kommunkationsschlüssel in ihr Addressbuch hinzuzufügen und es weiterhin nicht funktionert, entfernen Sie den betroffen Kontakt von Ihrem Addressbuch und senden Sie diesem eine neue Einladung.",
    ...
    "enter_answer": "Nachricht",
    "enter_answer_desc": "Geben Sie den Text der Antwort ein.",
    ...
    "items": "Elementen",
    "loading_answers": "Lade weitere Antwort(en)",
    ...
    "send-answer-header": "Antwort senden",
    "send-by-me": "Gesendet von mir",
    "send-mail": "Mail absenden",
    "send-new-mail": "Neue Mail schreiben",
    "sending": "Senden",
    "sent": "Gesendet",
    "sent-to": "Gesendet an",
