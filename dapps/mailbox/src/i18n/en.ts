...
export const en = {
  ...
  "_dappmailbox": {
    ...
    "comm-key-error": "An error occured while adding your shared communication key to your profile.<br>Please try again.<br><br>If you tried it again and it not works, please remove the contact from your address book and send a new invitation.",
    ...
    "enter_answer": "Message",
    "enter_answer_desc": "Insert the answer text.",
    ...
    "message-body": {
      "desc": "Enter the content of the message",
      "error": "You have to specify a text content to send the message!",
      "title": "Text content"
    },
    "message-title": {
      "desc": "Enter the title of the message",
      "error": "You have to specify a title to send the message!",
      "title": "Title"
    },
    ...
    "received": "Received",
    "recipient": {
      "desc": "Recipient of the new mail",
      "error": "You have to specify a recipient to send the mail!",
      "title": "Recipient"
    },
    "remove": "Delete",
    "send-answer": "Send Answer",
    "send-answer-header": "Send answer",
    "send-by-me": "Sent by me",
    "send-mail": "send mail",
    "send-new-mail": "Send new mail",
    "sending": "Sending",
    "sent": "Sent",
    "sent-to": "Send to",
