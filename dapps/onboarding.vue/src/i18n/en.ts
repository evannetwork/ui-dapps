...
export default {
  "_onboarding": {
    ...
    "sign-in": {
      ...
      "get-mnemonic-desc": "Insert your recovery key to restore your evan.network identity.",
    ...
    "sign-up": {
      ...
      "profile-informations-desc": "Please define an account name and a password.",
