Feature: EVE payments Vue
  ...
  Scenario: Checking amount when paying from Germany with an invalid German VAT ID
    ...
    When I click on button "Continue"
      ...
      And I select the entry "Germany" from the dropdown with the label "Company HQ Country"
  ...
  Scenario: Checking amount when paying from Italy with an invalid Italian VAT ID
    Given I log in to evan.network using vue
      And I click on "Identity" in main menu
      And I click on link to "wallet"
      And I click on button "Buy EVE"
  ...
  Scenario: Checking amount when paying from Austria with a valid Italian VAT ID
    ...
    When I click on button "Continue"
      ...
      And I set Input field with label "Postal Code" to "12345"
      And I set Input field with label "City" to "Test City"
      And I select the entry "Austria" from the dropdown with the label "Company HQ Country"
